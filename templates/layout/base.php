...
<head charset="UTF-8">
    ...
    <link rel="stylesheet" href="/myproject/webroot/css/style.css">
...
<nav class="main_header">
    ...
    <div class="main_user">
        ...
        <div id="users_list">
            <ul>
                <li><a href="<?= $this->Url->build("/users/view/" . $this->request->getSession()->read("id")) ?>">
                        Profil</a></li>
                <li><a href="<?= $this->Url->build("/users/edit/" . $this->request->getSession()->read("id")) ?>">Editează
                        profil </a></li>
                <li>
