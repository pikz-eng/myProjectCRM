<div class="row">
    <div class="col-sm-8">
        ...
        <div class="table-responsive" style="width:1500px">
            <table class="table table-bordered" style="width:1200px" style="height:auto">
...
<script>
    $(document).ready(function () {
            ...
            "columns": [{
...

                {
                    ...
                    "render": function (data, type, row) {
                        return '<button class="btn btn-primary btn-lg btn-block editBtn" " data-id="' + row.id + '" >Edit</button>';
                    }
                }
        ...
        $('#customersTable').on('click', '.editBtn', function () {
            editBtnClicked = true;
            var id = $(this).data('id');
            localStorage.setItem('editBtnClicked', 'true');
            window.location.href = '/myproject/customers/edit/' + id;
        });
